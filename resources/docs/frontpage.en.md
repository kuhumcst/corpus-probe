...
corpus-probe searches [corpora](/glossary#corpus) that are encoded with
the [IMS Open Corpus Workbench](/glossary#cwb). It shows the result as
a [concordance](/glossary#concordance). Each [hit](/glossary#hit) is on
a line of its own, with the words around it.

- [Search](/search) for a word, a phrase or a [CQP](/glossary#cqp)
...
- [Glossary](/glossary) explains the words that the interface uses.
  They are the words that the Corpus Workbench uses.
